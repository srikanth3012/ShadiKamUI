          ...
          {filteredEvents.length === 0 ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredEvents.map((event) => (
                <Card
                  key={event.id}
                  className={`hover:shadow-lg transition-all border-l-4 ${getPriorityColor(
                    event.priority
                  )}`}
                >
                  <div className="relative">
          ...
          <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
            ...
            <DialogContent className="max-w-2xl">
              <DialogHeader>
                ...
                <DialogDescription>
                  Start planning your special event by providing some basic
                  details
                </DialogDescription>
              </DialogHeader>
